var Gifffer = function() {
    ...
    var createContainer = function(w, h, el) {
        ...
        trngl[sa]('style', 'width:0;height: 0;border-top:14px solid transparent;border-bottom:14px solid transparent;border-left:14px solid rgba(255, 255, 255, 0.5);position:absolute;left:26px;top:16px;')
