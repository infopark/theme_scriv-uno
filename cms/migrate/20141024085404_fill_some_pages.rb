class FillSomePages < ::Scrivito::Migration
  def up
    ["/en/about_us", "/en/news", "/en/about_us/sub_content", "/en/about_us/next_sub_content"].each do |path|
