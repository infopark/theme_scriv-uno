class CreateBlogClass < ::Scrivito::Migration
  def up
    ...
    Obj.create(_obj_class: 'BlogPost', _path: "/blog/post2", title: "Things are looking good.", date: 10.days.ago, author: "Jane Doe", content: [
      TextWidget.new(content: "Since our relaunch two weeks ago we get a lot of praise for our newl site. Thanks, folks! We like improving things. And with the flexibility of a Rails app on our hands we will keep improving even more. Be sure to check in regularly. More content and new features to come soon."), 
