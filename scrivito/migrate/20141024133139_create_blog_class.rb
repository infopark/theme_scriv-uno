class CreateBlogClass < ::Scrivito::Migration
  def up
    ...
    Obj.create(_obj_class: 'BlogPost', _path: "/blog/post1", title: "First Blog Post", date: 3.weeks.ago, author: "John Doe", content: [
    ...
    Obj.create(_obj_class: 'BlogPost', _path: "/blog/post2", title: "Next Blog Post", date: 10.days.ago, author: "Jane Doe", content: [
    ...
    Obj.create(_obj_class: 'BlogPost', _path: "/blog/post3", title: "Third Blog Post", date: 1.day.ago, author: "Maxi Muster")
  end
end
